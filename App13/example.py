...
# Make one class for each window
class AgeCalculator(QWidget):
    def __init__(self):
        ...
        # When the button is clicked it activates the calculate_age method
...
# Start the app with sys - system, standard library,
# sys.argv -- list of arguments from the pc system
