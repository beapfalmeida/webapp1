...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\beatr\PycharmProjects\App 1 - Aulas 1 a 20\App1-GUI\venv2'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\beatr\PycharmProjects\App 1 - Aulas 1 a 20\App1-GUI\venv2\Scripts\deactivate.nu'
